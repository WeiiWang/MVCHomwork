...
namespace WebApplication3.Models
{
    public class 客戶聯絡人Repository : EFRepository<客戶聯絡人>, I客戶聯絡人Repository
    {
        ...
        public bool EmailDuplicate(int Id, int ClientId, string email)
        {
            if (Id != 0 && Find(Id).Email.Equals(email))
            {
                return false;
            }

            客戶聯絡人 聯絡人 = All().Where(x => x.客戶Id.Equals(ClientId)).FirstOrDefault(x => x.Email.Equals(email));
            return 聯絡人 != null ? true : false;
